...
@smokeTest
 Scenario Outline: INW-42 - Quick registration entering a previously registered "Cellphone" credential
    ...
    Examples:
        ...
        | 66000121          | 66000121    | NOMBRECXXI      | PRIAPELLIDOCXXI   | SEGAPELLIDOCXXI     | 66000121test@gmail.com  | Aaaaaaaaa1    | Aaaaaaaaa1     |66000122              | 66000122      | NOMBRECXXI    | PRIAPELLIDOCXXII      | SEGAPELLIDOCXXII      | 66000122test@gmail.com  | Aaaaaaaaa1      | Aaaaaaaaa1        |
...
@onlyThis
Scenario Outline: INW-163 - Quick registration with a "Names" field that contains spaces and insufficient characters
    Given I am on the 'Quick Registration' page
    When I fill the 'Quick Registration' form with the following values
        | Document Number   | <DocumentNumber>  |
        | Cellphone         | <Cellphone>       |
